...
CASES: list[Case] = [
    ...
    Case("libmc_scoreboard_probe_o0", "libmc_scoreboard_probe.c"),
    Case("libmc_execute_probe_o0", "libmc_execute_probe.c"),
    ...
    Case("opt_selector_merge_probe_o0", "opt_selector_merge_probe.c"),
