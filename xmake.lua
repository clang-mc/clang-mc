...
target("clang-mc-core")
    ...
    add_files(
        ...
        "src/cpp/ir/opt/Optimizer.cpp",
        "src/cpp/ir/opt/core/Pipeline.cpp",
        "src/cpp/ir/opt/passes/ConstantFoldingPass.cpp",
        "src/cpp/ir/opt/passes/SimplifyPass.cpp",
        "src/cpp/ir/opt/passes/DevirtualizePass.cpp",
        "src/cpp/ir/opt/passes/InlinePass.cpp",
        "src/cpp/ir/opt/passes/DeadCodePass.cpp",
        "src/cpp/ir/obf/Obfuscator.cpp",
        "src/cpp/ir/obf/core/Pipeline.cpp",
        "src/cpp/ir/obf/passes/ConstantHidingPass.cpp",
        "src/cpp/ir/obf/passes/IndirectCallPass.cpp",
